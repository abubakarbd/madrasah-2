...
?>  
							 ...
							 <div class="clearfix"> </div>
					            ...
					            <div class="col-md-4 form-group1">
					              <label class="control-label">খরচ কারির নাম</label>
					              <input type="text" name="name" placeholder="Share Amount" required="">
					            </div>
					            <div class="col-md-4 form-group1 form-last">
					              <label class="control-label">ভাউচার নং</label>
					              <input type="text" name="rnong" placeholder="Collection Amount" required="">
					            </div>
					            <div class="col-md-4 form-group1 form-last">
					            ...
					            <div class="col-md-6 form-group1">
					              ...
					              <textarea name="description" placeholder="বিবরণ" required=""></textarea>
					            </div>
